...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(document).on("click", ".dropdown", function (e) {
    var $dropdown_toggle = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).find(".dropdown__toggle");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var $form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#feedback');
  var locale = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').attr('data-locale');
    ...
    submitHandler: function submitHandler() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        success: function success(response) {
          $form.prepend('<div class="contact-form__row"><span class="' + response.status + '">' + response.message + '</span></div>').addClass('disabled');
        }
      });
    }
  });
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  function toggleNav() {
    ...
    if (state == -1) {
      state = !jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navigation__hamburger').hasClass('is-active');
    }

    Object(_scroll__WEBPACK_IMPORTED_MODULE_1__["toggleScrollock"])(state);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navigation__hamburger').toggleClass('is-active', state);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navigation__list').toggleClass('is-active', state);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.overlay').toggleClass('is-active', state);
  }
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", "a", function (e) {
    ...
    if (href && href.length > 1 && href[0] === '#') {
      var $el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(href);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", ".navigation__hamburger", function () {
    return toggleNav();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on("scroll load", function () {
    return $navigation.toggleClass("scrolled", jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > 100);
  });
});

/***/ }),

/***/ "./#src/js/modules/projects/api.js":
/*!*****************************************!*\
  !*** ./#src/js/modules/projects/api.js ***!
  \*****************************************/
/*! exports provided: default */
...
var _default = function _default() {
  ...
  _defineProperty(this, "getProjects", function (tag, count, page, skip, onSuccess) {
    var locale = jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').attr('data-locale');
    tag = tag.length ? '/' + tag : '';
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      ...
      beforeSend: function beforeSend() {
        return _this.lockLoading(true);
      },
      complete: function complete() {
        return _this.lockLoading(false);
      }
    });
  });

  _defineProperty(this, "appendProjects", function (projects, slides, maxPages) {
    var setEmpty = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var page = 0;

    if (setEmpty) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.project').remove();

      _this.slider.removeAllSlides();
    } else {
      page = +_this.loadMoreBtn.attr('data-page');
    }

    _this.slider.appendSlide(slides);

    _this.slider.update();

    _this.slider.lazy.load();

    _this.loadMoreBtn.before(projects).attr('data-page', page += 1).toggleClass('is-hidden', page >= maxPages || maxPages <= 1);
  });

  _defineProperty(this, "loadMore", function () {
    if (_this.loadMoreBtn.is('.is-hidden') || _this.isRequestBusy) {
      return;
    }

    var tag = _this.loadMoreBtn.attr('data-tag');

    var page = +_this.loadMoreBtn.attr('data-page');
    var isMobile = window.matchMedia("(max-width: 670px)").matches || window.matchMedia("(max-height: 480px)").matches;
    var count = isMobile ? 4 : 3;
    var skip = isMobile ? 0 : 1;

    _this.getProjects(tag, count, page, skip, function (response) {
      return _this.appendProjects(response.view.projects, response.view.slides, response.maxPages);
    });
  });

  _defineProperty(this, "changeTab", function (newTab) {
    var tabs = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tabs__item');
    var tag = newTab.attr('data-tag');

    _this.getProjects(tag, 4, 0, 0, function (response) {
      tabs.removeClass('is-active');
      newTab.addClass('is-active');

      _this.loadMoreBtn.attr('data-tag', tag);

      _this.appendProjects(response.view.projects, response.view.slides, response.maxPages, true);
    });
  });

  _defineProperty(this, "toggleSlider", function () {
    var slide = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -1;
    var state = slide != -1;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal').toggleClass('is-active', state);
    Object(_scroll__WEBPACK_IMPORTED_MODULE_2__["toggleScrollock"])(state);
    state && _this.slider.slideTo(slide, 0);
  });

  _defineProperty(this, "lockLoading", function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    _this.isRequestBusy = state;

    _this.loadMoreBtn.toggleClass('processing', state);

    if (state) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__wrapper').append('<div class="modal__preloader swiper-lazy-preloader"></div>');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__preloader').remove();
    }
  });

  this.loadMoreBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#loadmore');
  this.isRequestBusy = false;
  this.slider = Object(_swiper__WEBPACK_IMPORTED_MODULE_1__["default"])();
  this.slider.on('reachEnd', function () {
    return _this.slider.slides.length && setTimeout(_this.loadMore, 200);
  });
};
...
/***/ "./#src/js/modules/projects/index.js":
/*!*******************************************!*\
  !*** ./#src/js/modules/projects/index.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api */ "./#src/js/modules/projects/api.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var api = new _api__WEBPACK_IMPORTED_MODULE_1__["default"]();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", ".project", function (e) {
    e.preventDefault();
    api.toggleSlider(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).index());
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", ".modal__close", function (e) {
    e.preventDefault();
    api.toggleSlider();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '#loadmore', function (e) {
    e.preventDefault();
    api.loadMore();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tabs__item').on('click', function (e) {
    e.preventDefault();
    api.changeTab(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this));
  });
});

/***/ }),

/***/ "./#src/js/modules/projects/swiper.js":
/*!********************************************!*\
  !*** ./#src/js/modules/projects/swiper.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container', {
    slidesPerView: 1,
    speed: 400,
    spaceBetween: 120,
    grabCursor: true,
...
/*!***********************************!*\
  !*** ./#src/js/modules/scroll.js ***!
  \***********************************/
/*! exports provided: toggleScrollock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleScrollock", function() { return toggleScrollock; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
function toggleScrollock(state) {
  var $scrollable = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal__wrapper, .navigation__list').get();

  if (state) {
    scroll_lock__WEBPACK_IMPORTED_MODULE_1___default.a.disablePageScroll($scrollable);
  } else {
    scroll_lock__WEBPACK_IMPORTED_MODULE_1___default.a.enablePageScroll($scrollable);
  }
}
...
/* harmony import */ var _modules_projects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/projects */ "./#src/js/modules/projects/index.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  Object(_modules_hover__WEBPACK_IMPORTED_MODULE_1__["default"])();
  ...
  Object(_modules_projects__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
