...
/***/ "./#src/js/modules/form/config.js":
/*!****************************************!*\
  !*** ./#src/js/modules/form/config.js ***!
  \****************************************/
/*! exports provided: rules, messages */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../validator */ "./#src/js/modules/validator/index.js");
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config */ "./#src/js/modules/form/config.js");
/* harmony import */ var _helpers_makeRequest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/makeRequest */ "./#src/js/modules/helpers/makeRequest.js");
...
const onSubmit = (form, locale) => {
  ...
  Object(_helpers_makeRequest__WEBPACK_IMPORTED_MODULE_3__["default"])(locale + "/feedback", {
    method: 'POST',
    body: new FormData(form)
  }).then(result => printMessage(form, result.status, result.message)).catch(() => form.classList.remove('disabled')).finally(() => form.classList.remove('processing'));
};

/* harmony default export */ __webpack_exports__["default"] = (() => {
  const locale = document.body.getAttribute('data-locale');
  new _validator__WEBPACK_IMPORTED_MODULE_1__["default"]({
    selector: '#feedback',
    rules: _config__WEBPACK_IMPORTED_MODULE_2__["rules"],
    messages: _config__WEBPACK_IMPORTED_MODULE_2__["messages"][locale],
...
/***/ "./#src/js/modules/helpers/browser.js":
/*!********************************************!*\
  !*** ./#src/js/modules/helpers/browser.js ***!
  \********************************************/
/*! exports provided: default */
...
/***/ "./#src/js/modules/helpers/makeRequest.js":
/*!************************************************!*\
  !*** ./#src/js/modules/helpers/makeRequest.js ***!
  \************************************************/
/*! exports provided: default */
...
/***/ "./#src/js/modules/helpers/scrolLock.js":
/*!**********************************************!*\
  !*** ./#src/js/modules/helpers/scrolLock.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  function toggleNav(enable) {
    ...
    Object(_helpers_scrolLock__WEBPACK_IMPORTED_MODULE_0__["default"])(menuEnabled);
  }
...
/***/ "./#src/js/modules/projects/Projects.js":
/*!**********************************************!*\
  !*** ./#src/js/modules/projects/Projects.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Projects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Projects */ "./#src/js/modules/projects/Projects.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  const swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container', {
    slidesPerView: 1,
    speed: 400,
    threshold: 10,
    spaceBetween: 120,
...
/***/ "./#src/js/modules/scrolledHeader.js":
/*!*******************************************!*\
  !*** ./#src/js/modules/scrolledHeader.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _helpers_browser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/browser */ "./#src/js/modules/helpers/browser.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  document.body.classList.add(_helpers_browser__WEBPACK_IMPORTED_MODULE_1__["default"].isMobile() ? "touch" : "mouse");
});
...
class Validator {
  constructor(params) {
    _defineProperty(this, "appendMessage", (input, text = messageFallback) => {
    ...
    _defineProperty(this, "removeMessage", input => {
      if (input.classList.contains(this.className)) {
    ...
    _defineProperty(this, "isValid", (str, rules) => {
      let result = true;
    ...
    _defineProperty(this, "validateField", input => {
      let name = input.name;
...
_defineProperty(Validator, "validation", {
  required: str => str.length > 0,
  min: (str, val) => str.length >= val,
  max: (str, val) => str.length <= val,
  email: str => validator_lib_isEmail__WEBPACK_IMPORTED_MODULE_0___default()(str)
});

_defineProperty(Validator, "setValidationType", (fieldType, func) => Validator.validation[fieldType] = func);
...
*/
/* harmony default export */ __webpack_exports__["default"] = ((window, document, undefined) => {
  var classes = [];
  var tests = [];
  /**
   *
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_anchors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/anchors */ "./#src/js/modules/anchors.js");
...
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form */ "./#src/js/modules/form/index.js");
...
/* harmony import */ var _modules_webp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/webp */ "./#src/js/modules/webp.js");
...
Object(_modules_webp__WEBPACK_IMPORTED_MODULE_8__["default"])(window, document);
