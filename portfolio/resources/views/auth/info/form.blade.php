    ...
    <div class="section__body">
        ...
        >
            ...
            <div class="form__group">
                ...
                <input type="text" name="mail" id="mail" value="{{ $localization->mail }}">
            </div>
            <div class="form__group">
                <label for="phone">Телефон</label>
                <input type="text" name="phone" id="phone" value="{{ $localization->phone }}">
            </div>
            <div class="form__group">
                <label for="telegram">Telegram</label>
                <input type="text" name="telegram" id="telegram" value="{{ $localization->telegram }}">
            </div>
            <div class="form__group">
                <label for="linkedin">Linkedin</label>
                <input type="text" name="linkedin" id="linkedin" value="{{ $localization->linkedin }}">
            </div>
            <div class="form__group">
                <label for="linkedin">Behance</label>
                <input type="text" name="behance" id="behance" value="{{ $localization->behance }}">
            </div>
            <div class="form__group">
                <label for="github">Github</label>
                <input type="text" name="github" id="github" value="{{ $localization->github }}">
            </div>
            <div class="form__group form__group-row">
